  ...
  return (
    <section className='sort-box'>
      ...
      <div className='sort-options'>
        ...
        <label htmlFor="distance"><img className='sort-icon' alt='line drawing of sun' src='../space/sun.png'></img>Distance from sun</label>
        <input type="radio" onClick={updateSort} id="mass" name="sortCriteria" value="mass"></input>
        <label htmlFor="mass"><img className='sort-icon' alt='line drawing of asteroid' src='../space/asteroid.png'></img>Mass</label>
        ...
        <label htmlFor="gravity"><img className='sort-icon' alt='line drawing of meteor' src='../space/falling-star.png'></img>Gravity</label>
        <input type="radio" onClick={updateSort} id="lengthOfDay" name="sortCriteria" value="length_of_day"></input>
        <label htmlFor="lengthOfDay"><img className='sort-icon' alt='line drawing of spinning planet' src='../space/orbit.png'></img>Length of day</label>
        <input type="radio" onClick={updateSort} id="lengthOfYear" name="sortCriteria" value="length_of_year"></input>
        <label htmlFor="lengthOfYear"><img className='sort-icon' alt='line drawing of planets on orbital paths around sun' src='../space/solar-system.png'></img>Length of year</label>
        <input type="radio" onClick={updateSort} id="numberOfMoons" name="sortCriteria" value="number_of_moons"></input>
        <label htmlFor="numberOfMoons"><img className='sort-icon' alt='line drawing of one moon eclipsing another' src='../space/eclipse.png'></img>Number of moons</label>
      </div>
    </section>
  )
}
