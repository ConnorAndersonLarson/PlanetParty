  ...
  return (
    <section className='sort-box'>
      ...
      <div className='sort-options'>
        ...
        <label htmlFor="diameter"><img className='sort-icon' alt='astronaut icon' src='../space/visiter.png'></img>Diameter</label>
        <input type="radio" onClick={updateSort} id="gravity" name="sortCriteria" value="gravity"></input>
        <label htmlFor="gravity"><img className='sort-icon' alt='astronaut icon' src='../space/falling-star.png'></img>Gravity</label>
        <input type="radio" onClick={updateSort} id="lengthOfDay" name="sortCriteria" value="length_of_day"></input>
        <label htmlFor="lengthOfDay"><img className='sort-icon' alt='astronaut icon' src='../space/planet-axis-2.svg'></img>Length of day</label>
        <input type="radio" onClick={updateSort} id="lengthOfYear" name="sortCriteria" value="length_of_year"></input>
        <label htmlFor="lengthOfYear"><img className='sort-icon' alt='astronaut icon' src='../space/solar-system.png'></img>Length of year</label>
        <input type="radio" onClick={updateSort} id="numberOfMoons" name="sortCriteria" value="number_of_moons"></input>
        <label htmlFor="numberOfMoons"><img className='sort-icon' alt='astronaut icon' src='../space/eclipse.png'></img>Number of moons</label>
      </div>
    </section>
  )
}
