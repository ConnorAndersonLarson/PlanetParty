  ...
  return (
    <section className='sort-box'>
      ...
      <div className='sort-options'>
        ...
        <label htmlFor="mass"><img className='sort-icon' alt='astroid icon' src='../space/asteroid.png'></img>Mass</label>
        ...
        <label htmlFor="lengthOfDay"><img className='sort-icon' alt='orbit icon' src='../space/orbit.png'></img>Length of day</label>
